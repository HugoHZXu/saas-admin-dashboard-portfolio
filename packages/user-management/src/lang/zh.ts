const zhMessages: Record<string, string> = {
  ...
  'userManagement.activity.action.ACTIVATE_USER': '启用用户',
  ...
  'userManagement.activity.summary.ACTIVATE_USER': '{actorName} 启用了 {targetName}。',
  ...
  'userManagement.activity.summary.UNKNOWN': '{actorName} 为 {targetName} 记录了未映射活动。',
};
