export const hideAttributes = (hiddenKeys: string[]) => {
  ...
  const hiddenAttributeArgTypes = hiddenKeys.reduce<Record<string, typeof hideAttributeOption>>((obj, key) => {
...
export const disableAttributes = (disableKeys: string[]) => {
  ...
  const disabledAttributeArgTypes = disableKeys.reduce<Record<string, typeof disableAttributeOption>>((obj, key) => {
